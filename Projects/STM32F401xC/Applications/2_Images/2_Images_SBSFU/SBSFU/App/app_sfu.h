...
#define SFU_NO_SWAP 1                              /*!< FW upgrade installation process without swap area */
...
#define SECBOOT_DISABLE_SECURITY_IPS 1  /*!< Disable all security IPs at once when activated */
