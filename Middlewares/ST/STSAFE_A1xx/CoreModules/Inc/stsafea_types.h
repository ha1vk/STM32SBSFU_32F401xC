...
#define STSAFEA_ST_NUMBER_LENGTH                   0x09U    /*!< ST number length */
/**
  * @}
  */
...
/** @defgroup STSAFEA_Buffer_size STSAFE-A1xx's size definition
  * @{
  */
#define STSAFEA_BUFFER_DATA_PACKET_SIZE        507U /*!< 507: Maximum buffer length can be handled by the device */
...
#define STSAFEA_BUFFER_DATA_EXTENSION_SIZE     16U /*!< Additional 16 bytes = 2 Bytes CRC + 10 extra bytes used during
                                                        RMAC calculation + 4 spare bytes
                                                        used for optimization by the Low Level layer to move bytes
                                                        inside the same buffer */
/*!< Max extended buffer size in bytes */
#define STSAFEA_BUFFER_MAX_SIZE                (STSAFEA_BUFFER_DATA_PACKET_SIZE + STSAFEA_BUFFER_DATA_EXTENSION_SIZE)
...
/*!< C-MAC presence code, if '1' indicates the presence of a C-MAC */
#define STSAFEA_CMD_HEADER_CMAC_POS             (7U)
/*!< 0b10000000  */
#define STSAFEA_CMD_HEADER_CMAC_MSK             (0x1U << STSAFEA_CMD_HEADER_CMAC_POS)
/*!< C-MAC presence enabled */
#define STSAFEA_CMD_HEADER_CMACEN               STSAFEA_CMD_HEADER_CMAC_MSK
/*!< R-MAC request code, if '1' indicates whether an R-MAC is requested */
#define STSAFEA_CMD_HEADER_RMAC_POS             (6U)
/*!< 0b01000000 */
#define STSAFEA_CMD_HEADER_RMAC_MSK             (0x1U << STSAFEA_CMD_HEADER_RMAC_POS)
/*!< R-MAC request enabled */
#define STSAFEA_CMD_HEADER_RMACEN               STSAFEA_CMD_HEADER_RMAC_MSK
/*!< Secure Channel Type, if '1' indicates C/R-MAC are HOST, if '0' indicates C/R-MAC are defined by current session */
#define STSAFEA_CMD_HEADER_SCHN_POS             (5U)
/*!< 0b00100000 */
#define STSAFEA_CMD_HEADER_SCHN_MSK             (0x1U << STSAFEA_CMD_HEADER_SCHN_POS)
/*!< Secure Channel HOST enabled */
#define STSAFEA_CMD_HEADER_SCHN_HOSTEN          (STSAFEA_CMD_HEADER_SCHN_MSK)
/*!< MAC bits mask */
#define STSAFEA_CMD_HEADER_MAC_MSK              (STSAFEA_CMD_HEADER_CMAC_MSK | \
                                                 STSAFEA_CMD_HEADER_RMAC_MSK | \
                                                 STSAFEA_CMD_HEADER_SCHN_MSK)
/*!< No MAC */
#define  STSAFEA_MAC_NONE        (0x0U)
/*!< Regular Command MAC  */
#define  STSAFEA_MAC_RMAC        (STSAFEA_CMD_HEADER_RMACEN)
/*!< Regular Response MAC */
#define  STSAFEA_MAC_CRMAC       (STSAFEA_CMD_HEADER_CMACEN | STSAFEA_CMD_HEADER_RMACEN)
/*!< Host Command MAC */
#define  STSAFEA_MAC_HOST_CMAC   (STSAFEA_CMD_HEADER_CMACEN | STSAFEA_CMD_HEADER_SCHN_HOSTEN)
/*!< Host Response MAC */
#define  STSAFEA_MAC_HOST_RMAC   (STSAFEA_CMD_HEADER_CMACEN | \
                                  STSAFEA_CMD_HEADER_RMACEN | \
                                  STSAFEA_CMD_HEADER_SCHN_HOSTEN )
...
/*!< Signature generation over command and response sequences */
#define STSAFEA_PRVKEY_MODOPER_AUTHFLAG_CMD_RESP_SIGN_POS    (3U)
/*!< 0b1000*/
#define STSAFEA_PRVKEY_MODOPER_AUTHFLAG_CMD_RESP_SIGN_MSK    (0x1U \
                                                              << STSAFEA_PRVKEY_MODOPER_AUTHFLAG_CMD_RESP_SIGN_POS)
/*!< Signature generation over command and response sequences enabled */
#define STSAFEA_PRVKEY_MODOPER_AUTHFLAG_CMD_RESP_SIGNEN      STSAFEA_PRVKEY_MODOPER_AUTHFLAG_CMD_RESP_SIGN_MSK
/*!< Signature generation over message digest generated by the host */
#define STSAFEA_PRVKEY_MODOPER_AUTHFLAG_MSG_DGST_SIGN_POS    (2U)
#define STSAFEA_PRVKEY_MODOPER_AUTHFLAG_MSG_DGST_SIGN_MSK    (0x1U \
                                                              << STSAFEA_PRVKEY_MODOPER_AUTHFLAG_MSG_DGST_SIGN_POS)
/*!< Signature generation over message digest generated by the host enabled */
#define STSAFEA_PRVKEY_MODOPER_AUTHFLAG_MSG_DGST_SIGNEN      STSAFEA_PRVKEY_MODOPER_AUTHFLAG_MSG_DGST_SIGN_MSK
/*!< Key Establishment */
#define STSAFEA_PRVKEY_MODOPER_AUTHFLAG_KEY_ESTABLISH_POS    (0U)
#define STSAFEA_PRVKEY_MODOPER_AUTHFLAG_KEY_ESTABLISH_MSK    (0x1U \
                                                              << STSAFEA_PRVKEY_MODOPER_AUTHFLAG_KEY_ESTABLISH_POS)
/*!< Key Establishment enabled */
#define STSAFEA_PRVKEY_MODOPER_AUTHFLAG_KEY_ESTABLISHEN      STSAFEA_PRVKEY_MODOPER_AUTHFLAG_KEY_ESTABLISH_MSK
/*!< bits mask */
#define STSAFEA_PRVKEY_MODOPER_AUTHFLAG_MAC_MSK              (STSAFEA_PRVKEY_MODOPER_AUTHFLAG_CMD_RESP_SIGN_MSK | \
                                                              STSAFEA_PRVKEY_MODOPER_AUTHFLAG_MSG_DGST_SIGN_MSK | \
                                                              STSAFEA_PRVKEY_MODOPER_AUTHFLAG_KEY_ESTABLISH_MSK)
/**
  * @}
  */
...
#define STSAFEA_AC_ALWAYS                     (0x00U)
/*!< Access condition: Host. MAC or Auth AC must be fulfilled or the command must have a valid host C-MAC */
#define STSAFEA_AC_HOST                       (0x01U)
/*!< Access condition: Auth. A valid Admin C-MAC must have been received on the command or on some previous command. */
#define STSAFEA_AC_AUTH                       (0x02U)
/*!< Access condition: MAC. Command must have a valid Admin C-MAC. */
#define STSAFEA_AC_MAC                        (0x03U)
/*!< Access condition: Never, other values */
#define STSAFEA_AC_NEVER                      ( (0x04U) | (0x05U) | (0x06U) | (0x07U) )
/*!< 0x00000111 */
#define STSAFEA_AC_MSK                        (0x3U)
/**
  * @}
  */
...
/*!< Both Command / Response encryption */
#define STSAFEA_ENCRYPTION_COMMAND_RESPONSE        (STSAFEA_ENCRYPTION_COMMAND | STSAFEA_ENCRYPTION_RESPONSE)
/**
  * @}
  */
...
/** @defgroup STSAFEA_Key_Sha_Sign_Length Crypto length
  * @{
  */
/*ECDSA_SHA256 Hash Len */
#define STSAFEA_SHA_256_LENGTH                                          32U
/*ECDSA_SHA256 R,S, X,and Y Len */
#define STSAFEA_XYRS_ECDSA_SHA256_LENGTH                                STSAFEA_SHA_256_LENGTH
/*ECDSA_SHA256 Signature Len */
#define STSAFEA_SIGN_ECDSA_SHA256_LENGTH                                (2*STSAFEA_XYRS_ECDSA_SHA256_LENGTH)
/*ECDSA_SHA384 Hash Len */
#define STSAFEA_SHA_384_LENGTH                                          48U
/*ECDSA_SHA384 R,S, X,and Y Len */
#define STSAFEA_XYRS_ECDSA_SHA384_LENGTH                                STSAFEA_SHA_384_LENGTH
/*ECDSA_SHA384 Signature Len */
#define STSAFEA_SIGN_ECDSA_SHA384_LENGTH                                (2*STSAFEA_XYRS_ECDSA_SHA384_LENGTH)
/**
  * @}
  */


/** @defgroup STSAFEA_ECC_Curve_OID ECC curve information
  * @{
  */
/*!< ASN.1 X9.62 Curve Object Identifier : NIST-P256 OID */
#define STSAFEA_ECC_CURVE_OID_NIST_P_256              ((int8_t*) "\x2A\x86\x48\xCE\x3D\x03\x01\x07")
/*!< Length of ASN.1 X9.62 Curve Object Identifier: NIST-P256 OID */
#define STSAFEA_ECC_CURVE_OID_NIST_P_256_LEN          0x08U
/*!< DER encoded ASN.1 X9.62 Curve Object Identifier: 0x06 |Len| NIST-P256 OID */
#define STSAFEA_ECC_CURVE_OID_NIST_P_256_DER          ((int8_t*) "\x06\x08\x2A\x86\x48\xCE\x3D\x03\x01\x07")
/*!< Length of DER encoded ASN.1 X9.62 Curve Object Identifier: 0x06 |Len| NIST-P256 OID */
#define STSAFEA_ECC_CURVE_OID_NIST_P_256_DER_LEN      ( 2U + STSAFEA_ECC_CURVE_OID_NIST_P_256_LEN )
/*!< ASN.1 X9.62 Curve Object Identifier : BRAINPOOL-P256 OID */
#define STSAFEA_ECC_CURVE_OID_BRAINPOOL_P_256         ((int8_t*) "\x2B\x24\x03\x03\x02\x08\x01\x01\x07")
/*!< Length of ASN.1 X9.62 Curve Object Identifier: BRAINPOOL-P256 OID */
#define STSAFEA_ECC_CURVE_OID_BRAINPOOL_P_256_LEN     0x09U
/*!< DER encoded ASN.1 X9.62 Curve Object Identifier: 0x06 |Len| BRAINPOOL-P256 OID */
#define STSAFEA_ECC_CURVE_OID_BRAINPOOL_P_256_DER     ((int8_t*) "\x06\x09\x2B\x24\x03\x03\x02\x08\x01\x01\x07")
/*!< Length of DER encoded ASN.1 X9.62 Curve Object Identifier: 0x06 |Len| BRAINPOOL-P256 OID */
#define STSAFEA_ECC_CURVE_OID_BRAINPOOL_P_256_DER_LEN ( 2U + STSAFEA_ECC_CURVE_OID_BRAINPOOL_P_256_LEN )
/*!< ASN.1 X9.62 Curve Object Identifier : NIST-P384 OID */
#define STSAFEA_ECC_CURVE_OID_NIST_P_384              ((int8_t*) "\x2B\x81\x04\x00\x22")
/*!< Length of ASN.1 X9.62 Curve Object Identifier: NIST-P384 OID */
#define STSAFEA_ECC_CURVE_OID_NIST_P_384_LEN          0x05U
/*!< DER encoded ASN.1 X9.62 Curve Object Identifier: 0x06 |Len| NIST-P384 OID */
#define STSAFEA_ECC_CURVE_OID_NIST_P_384_DER          ((int8_t*) "\x06\x05\x2B\x81\x04\x00\x22")
/*!< Length of DER encoded ASN.1 X9.62 Curve Object Identifier: 0x06 |Len| NIST-P384 OID */
#define STSAFEA_ECC_CURVE_OID_NIST_P_384_DER_LEN      ( 2U + STSAFEA_ECC_CURVE_OID_NIST_P_384_LEN )
/*!< ASN.1 X9.62 Curve Object Identifier : BRAINPOOL-P384 OID */
#define STSAFEA_ECC_CURVE_OID_BRAINPOOL_P_384         ((int8_t*) "\x2B\x24\x03\x03\x02\x08\x01\x01\x0B")
/*!< Length of ASN.1 X9.62 Curve Object Identifier: BRAINPOOL-P384 OID */
#define STSAFEA_ECC_CURVE_OID_BRAINPOOL_P_384_LEN     0x09U
/*!< DER encoded ASN.1 X9.62 Curve Object Identifier: 0x06 |Len| BRAINPOOL-P384 OID */
#define STSAFEA_ECC_CURVE_OID_BRAINPOOL_P_384_DER     ((int8_t*) "\x06\x09\x2B\x24\x03\x03\x02\x08\x01\x01\x0B")
/*!< Length of DER encoded ASN.1 X9.62 Curve Object Identifier: 0x06 |Len| BRAINPOOL-P384 OID */
#define STSAFEA_ECC_CURVE_OID_BRAINPOOL_P_384_DER_LEN ( 2U + STSAFEA_ECC_CURVE_OID_BRAINPOOL_P_384_LEN )
/*!< Null value */
#define STSAFEA_ECC_CURVE_OID_NULL                    ((int8_t*) "\x00")
/*!< Length of LEN field */
#define STSAFEA_ECC_CURVE_OID_LEN                     0x02U
/**
  * @}
  */
...
#define STSAFEA_R_MAC_LENGTH(mac)           ((uint16_t)((( ( mac ) \
                                                           & STSAFEA_CMD_HEADER_RMACEN) == STSAFEA_CMD_HEADER_RMACEN) \
                                                        ? STSAFEA_MAC_LENGTH : 0x00U))
...
/* To prevent gcc/g++ warnings for unused param and MISRA-C2012-Rule-8.13 violation with unused pointer params */
#define STSAFEA_UNUSED_PTR(X)               *(&(X)) = *(&(X))
/* To prevent gcc/g++ warnings for not-const and not-modified unused param */
#define STSAFEA_UNMODIFIED_PTR(X)           *(&(X)) = *(&(X))
...
/**
  ...
  */
typedef void (* StSafeA_HashFunction_t)(StSafeA_HashTypes_t in_hash_type,
                                        void *in_sha_ctx, uint8_t *in_input_message, uint32_t in_input_message_length);
...
typedef struct
{
  /*!< STSAFE_A's type of hash */
  StSafeA_HashTypes_t     HashType;
  /*!< STSAFE_A's Hash Update function used to prepare commands */
  StSafeA_HashFunction_t  HashFuncPtr;
  /*!< STSAFE_A's hash context */
  void                    *HashCtx;
  /*!< STSAFE_A's hash result sized at the max possible length */
  uint8_t                 HashRes[STSAFEA_SHA_384_LENGTH];
} StSafeA_Hash_t;
